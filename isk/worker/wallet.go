...
func characterWallet(ctx context.Context, user *db.User) ([]int32, error) {
	charIDs := []int32{}
	...
	return charIDs, saveWalletRun(ctx, donations, getNames(ctx, donations))
}
...
func saveWalletRun(
	...
	return db.SaveCharacterDonations(ctx, donations, affiliations, true)
}
